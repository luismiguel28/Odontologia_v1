        ...
        <div class=" table-responsive py-1 px-1 ">
            <table id="miTabla" class="  py-3 table table-striped table-bordered w-100">
                ...
                <tbody>
                    ...
                    $sql = "SELECT id_cita, id_persona, descripcioncita, Fecha_cita,id_hora, DATE_FORMAT(horario.horario, '%H:%i') 
                           as horario, estado from cita,horario where cita.id_hora=horario.id_horario and id_persona = $idcita;";
